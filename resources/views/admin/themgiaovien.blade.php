        ...
        <div class="card card-outline-primary">
            <div class="card-body">
                <div class="form-validation">
                    <form action="{{route('themgiaovienprocess')}}" method="post" class="form-valide" id="formthemgiaovien">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="custom-control custom-radio">
                                                <input type="radio" @if(old('rdoGioiTinh')==1) checked @endif  name="rdoGioiTinh" value="1" class="form-check-input">
                                                <span class="custom-control-indicator"></span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="val_ngaysinh">Ngày sinh</label>
                                         <input type="date" required name="txtNgaySinh" class="form-control"  value="{{old('txtNgaySinh')}}">
                                    </div>
                                </div>                           
                             </div>
                              <div class="row">
                             ...
                             <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="txtTaiKhoan" class="form-control"  value="{{old('txtTaiKhoan')}}" placeholder="Nhập tài khoản">
                                    </div>
                                </div>                           
                             </div>
                             <div class="row">
