...
<html lang="fr">
  ...
  <body class="cm-login">
    ...
    <div class="text-center" style="padding:70px 0 30px 0;background:#fff;border-bottom:1px solid #ddd">
      <img src="{{asset('img/uet.png')}}" width="700" height="150">
    </div>
	     ...
	     <div class="col-xs-12">
          <div class="form-group">
      	    <div class="input-group">
      	      ...
      	      <input type="text" name="txtTaiKhoan" autofocus required class="form-control" autofocus placeholder="Tài khoản" >
      	    </div>
                </div>
                <div class="form-group">
      	    <div class="input-group">
      	      <div class="input-group-addon"><i class="fa fa-fw fa-lock"></i></div>
      	      <input type="password" name="txtMatKhau" required class="form-control" placeholder="Mật khẩu">
      	    </div>
          </div>
        </div>
	       <div class="col-xs-6">
