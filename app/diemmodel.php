...
class diemmodel extends Model
{
    ...
    public function thongketheochuyennganh($machuyennganh, $mamonhoc , $ketqua)
    {
        ...
        //         'diem.ketqua'=>$ketqua,
        //     ])->get();
        $sql = "select sinhvien.masinhvien,lop.tenlop, sinhvien.tensinhvien,diem.diemthanhphan, diem.diemcuoiky, diem.diemtong, diem.diemchu,diem.diemhe4, diem.ketqua from diem 
    ...
    public function thongketheolop($malop, $mamonhoc , $ketqua)
    {
        ...
        //         'diem.ketqua'=>$ketqua,
        //     ])->get();
        $sql = "select sinhvien.masinhvien,lop.tenlop, sinhvien.tensinhvien,diem.diemthanhphan, diem.diemcuoiky, diem.diemtong, diem.diemchu,diem.diem, diem.ketqua from diem 
            inner join sinhvien on diem.masinhvien = sinhvien.masinhvien 
            inner join lichhoc on diem.malich = lichhoc.malich 
            inner join lop on lichhoc.malop = lop.malop 
            inner join chuyennganh on lop.machuyennganh = chuyennganh.machuyennganh 
    ...
    {
        $sql = "select sinhvien.masinhvien,lop.tenlop, monhoc.tenmonhoc, sinhvien.tensinhvien,diem.diemthanhphan, diem.diemcuoiky, diem.diemtong, diem.diemchu,diem.diemhe4, diem.ketqua from diem 
            inner join sinhvien on diem.masinhvien = sinhvien.masinhvien 
            inner join lichhoc on diem.malich = lichhoc.malich 
            inner join lop on lichhoc.malop = lop.malop 
            inner join chuyennganh on lop.machuyennganh = chuyennganh.machuyennganh 
